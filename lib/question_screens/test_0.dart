            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const Text("Complete the Test",
                    style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
                  ),
                  const Text("Be yourself and answer honestly to find \nyour personality type.",
                    style: TextStyle(color: Colors.white, ),
                    textAlign: TextAlign.center,
                  ),
                  SizedBox(height: 30,),
                  SvgPicture.asset("images/theory.svg", width: 150, height: 130,),
                  const Text("View Your Results",
                    style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
                  ),
                  const Text("Learn how your skills influences many areas\n of your life.",
                    style: TextStyle(color: Colors.white,),
                    textAlign: TextAlign.center,
                  ),
                ],
