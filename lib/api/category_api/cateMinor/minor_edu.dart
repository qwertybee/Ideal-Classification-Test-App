...
//
//     final minorEdu = minorEduFromJson(jsonString);

import 'dart:convert';

MinorEdu minorEduFromJson(String str) => MinorEdu.fromJson(json.decode(str));

String minorEduToJson(MinorEdu data) => json.encode(data.toJson());
...
class MinorEdu {
  ...
  factory MinorEdu.fromJson(Map<String, dynamic> json) => MinorEdu(
