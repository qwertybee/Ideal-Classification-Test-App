...
//
//     final detailEdu = detailEduFromJson(jsonString);

import 'dart:convert';

DetailEdu detailEduFromJson(String str) => DetailEdu.fromJson(json.decode(str));

String detailEduToJson(DetailEdu data) => json.encode(data.toJson());
...
class DetailEdu {
  ...
  factory DetailEdu.fromJson(Map<String, dynamic> json) => DetailEdu(
