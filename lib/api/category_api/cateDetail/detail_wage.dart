...
//
//     final detailWage = detailWageFromJson(jsonString);

import 'dart:convert';

DetailWage detailWageFromJson(String str) => DetailWage.fromJson(json.decode(str));

String detailWageToJson(DetailWage data) => json.encode(data.toJson());
...
class DetailWage {
  ...
  factory DetailWage.fromJson(Map<String, dynamic> json) => DetailWage(
