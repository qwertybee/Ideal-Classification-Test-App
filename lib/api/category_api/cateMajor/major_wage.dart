...
MajorWage majorWageFromJson(String str) => MajorWage.fromJson(json.decode(str));

String majorWageToJson(MajorWage data) => json.encode(data.toJson());
...
class MajorWage {
  ...
  factory MajorWage.fromJson(Map<String, dynamic> json) => MajorWage(
