...
//
//     final majSkill = majSkillFromJson(jsonString);

import 'dart:convert';

MajSkill majSkillFromJson(String str) => MajSkill.fromJson(json.decode(str));

String majSkillToJson(MajSkill data) => json.encode(data.toJson());
...
class MajSkill {
  ...
  factory MajSkill.fromJson(Map<String, dynamic> json) => MajSkill(
...
enum IdPumsOccupation { THE_110000290000 }

final idPumsOccupationValues = EnumValues({
  "110000-290000": IdPumsOccupation.THE_110000290000
});
...
enum PumsOccupation { MANAGEMENT_BUSINESS_SCIENCE_ARTS_OCCUPATIONS }

final pumsOccupationValues = EnumValues({
  "Management, business, science, & arts occupations": PumsOccupation.MANAGEMENT_BUSINESS_SCIENCE_ARTS_OCCUPATIONS
});
...
enum SlugPumsOccupation { MANAGEMENT_BUSINESS_SCIENCE_ARTS_OCCUPATIONS }

final slugPumsOccupationValues = EnumValues({
  "management-business-science-arts-occupations": SlugPumsOccupation.MANAGEMENT_BUSINESS_SCIENCE_ARTS_OCCUPATIONS
});
