...
//
//     final majEdu = majEduFromJson(jsonString);

import 'dart:convert';

MajEdu majEduFromJson(String str) => MajEdu.fromJson(json.decode(str));

String majEduToJson(MajEdu data) => json.encode(data.toJson());
...
class MajEdu {
  ...
  factory MajEdu.fromJson(Map<String, dynamic> json) => MajEdu(
