...
class _DisplayBroadState extends State<DisplayBroad> {
  ...
  void getMaxSkill() {
    if (broadSkill != null) {
      ...
      int highestSkill = broadSkill!.data[0].lvValue.toInt();
              ...
              child: Column(
                children: [
                  ...
                  Text("In ${broadWage!.data[0].year.toString()}, ${widget.title} earned an "
                      "average yearly salary of ${broadWage!.data[0].averageWage.toString()},"
                  ...
                  SfCartesianChart(
                    ...
                    primaryYAxis: NumericAxis(edgeLabelPlacement: EdgeLabelPlacement.shift,
                        ...
                        title: AxisTitle(text: 'Average annual salary in ${broadWage!.data[0].year}')),
                  ),
                  Text("EDUCATION\n"),
                  ...
                  Text("SKILLS ${broadSkill!.data[0].lvValue.toString()}\n"), // match title as well
                  ...
                  SizedBox(
                    ...
                    child: SfCartesianChart(
                      ...
                      primaryYAxis: NumericAxis(edgeLabelPlacement: EdgeLabelPlacement.shift,
                          // numberFormat: NumberFormat.simpleCurrency(decimalDigits: 0),
                          title: AxisTitle(text: 'Skills Element Value in ${broadSkill!.data[0].year}')),
                    ),
                  ),
                ],
              ),
